...
var metricsContext = 'context-metrics';
var labelsContext = 'context-labels';
var labelValuesContext = 'context-label-values';
...
function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.refreshLabelSuggestions = function (metricName) {
      // Fetch label suggestions and store them in state
      _this.props.datasource.fetchMetricLabels(metricName).then(function (res) {
        var labelNameSuggestions = [];
        var labelValueSuggestions = {};
        res.data['metric-labels'].forEach(function (label) {
          var labelKey = label['label-key'];
          labelNameSuggestions.push({
            label: labelKey
          });
          labelValueSuggestions[labelKey] = label['label-values'].map(function (value) {
            return {
              label: value
            };
          });
        ...
        _this.setState({
          labelNameSuggestions: labelNameSuggestions,
          labelValueSuggestions: labelValueSuggestions,
          errorMessage: ''
        });
      })["catch"](function (error) {
        var _a, _b, _c, _d;

        var errorMessage = (_d = (_c = (_b = (_a = error === null || error === void 0 ? void 0 : error.data) === null || _a === void 0 ? void 0 : _a.errors[0]) === null || _b === void 0 ? void 0 : _b.message) !== null && _c !== void 0 ? _c : error.message) !== null && _d !== void 0 ? _d : 'Unexpected Error';
    ...
    _this.onSelectMetric = function (values) {
      var selectedMetricName = values[0];

      _this.onQueryChange(selectedMetricName, true);

      _this.refreshLabelSuggestions(selectedMetricName);
    ...
    _this.cleanText = function (s) {
      ...
      var cleanedText = lastPart.trimLeft().replace(/^"/, '');
      var invalidSuffixRegex = /["})]/; // Shave off invalid trailing characters: ", } and )
    ...
    _this.onWillApplySuggestion = function (suggestion, suggestionsState) {
      // Modify suggestion based on context
      switch (suggestionsState.typeaheadContext) {
        case metricsContext:
          {
            _this.refreshLabelSuggestions(suggestion);

            _this.setState({
              selectedMetricName: suggestion
            });
  ...
  QueryEditor.prototype.render = function () {
    ...
    }))), this.state.errorMessage && // TODO: Firm up error states
...
/*!***********************!*\
  !*** ./datasource.ts ***!
  \***********************/
/*! exports provided: DataSource, generateSortedTimestamps, generateTimestampMap, generateFieldName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateFieldName", function() { return generateFieldName; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
...
function (_super) {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            if (error_1 && error_1.data && error_1.data.errors && error_1.data.errors.length > 0) {
              // display the first error
              throw {
                message: error_1.data.errors[0]
              };
            } else {
              throw error_1;
            }
  ...
  DataSource.prototype.fetchMetricLabels = function (metricName) {
    return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().get(this.url + "/telemetry_labels/" + metricName);
  };
...
function generateFieldName(groupLabels, queryText) {
  if (!groupLabels || groupLabels.length === 0) {
    return queryText;
  }

  var formattedLabels = groupLabels.sort(function (a, b) {
    return a.localeCompare(b);
  }) // Surround label value in double quotes (e.g. 'key=value' => 'key="value"')
  .map(function (labelKeyAndValue) {
    return labelKeyAndValue.replace('=', '="') + '"';
  }).join(', ');
